...
const trial = [
  ...
  },
  {
    ...
    text: (sub) => body(sub.name, [
      "After one week of monitoring, here's what we usually uncover:",
      "",
  ...
  },
  {
    ...
    text: (sub) => body(sub.name, [
      "You're 14 days into your trial. By now your dashboard has:",
      "",
      "- 2 weeks of daily CRO health scores",
      ...
      "",
      "Your trial runs for 7 more days. After that, you can continue with a plan that fits your business.",
      "",
      "Want to talk about what we've found? Reply to this email and I'll walk you through it.",
    ]),
  },
  {
    day: 19,
    ...
    text: (sub) => body(sub.name, [
      ...
      "",
      "No pressure — but the data stops flowing on day 21.",
    ]),
  },
  {
    day: 21,
    ...
    text: (sub) => body(sub.name, [
      ...
      "",
      "If you want to keep your dashboard running, reply to this email or book a quick call:",
      "",
      "Plans start at $297/month — less than what most businesses spend on a single ad campaign, and you get 14 intelligence layers running 24/7.",
      "",
...
const scorecard = [
  {
    ...
    text: (sub) => {
      ...
      return body(sub.name, [
        ...
        "",
        "Want to see exactly what's happening with your marketing? We run 14 intelligence layers on your site — free for 21 days:",
        "",
        "https://badir.studio/offer",
      ]);
    },
  ...
  },
  {
    ...
    text: (sub) => body(sub.name, [
      ...
      "",
      "See it in action — free for 21 days:",
      "https://badir.studio/offer",
    ]),
  },
  {
    ...
    text: (sub) => body(sub.name, [
      ...
      "",
      "14 intelligence layers. 21 days free. No credit card.",
      "",
      "https://badir.studio/offer",
      "",
